...
class CameraMovementEstimator():
    ...
    def get_camera_movement(self, frames , read_from_stub , stub_path = None):
        ...
        old_features = cv.goodFeaturesToTrack(old_gray , 100 , 0.3, 7)
        ...
        for frame_num in range(1, len(frames)):
            ...
            if max_distance > self.minimum_distances :
